...
GetItemEntry sGetItemTable[GI_MAX - 1] = {
    ...
    GET_ITEM(ITEM_SHIP, OBJECT_UNSET_0, GID_NONE, CUSTOM_MESSAGE_ID, GIFIELD(GIFIELD_20 | GIFIELD_NO_COLLECTIBLE, 0),
             0),
    // GI_ARCHIPELAGO_PROGRESSIVE
    GET_ITEM(ITEM_NONE, OBJECT_ARCHIPELAGO_ITEM, GID_ARCHIPELAGO_PROGRESSIVE, CUSTOM_MESSAGE_ID,
             GIFIELD(GIFIELD_20 | GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_LONG),
    // GI_ARCHIPELAGO_USEFUL
    GET_ITEM(ITEM_NONE, OBJECT_ARCHIPELAGO_ITEM, GID_ARCHIPELAGO_USEFUL, CUSTOM_MESSAGE_ID,
             GIFIELD(GIFIELD_20 | GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_LONG),
    // GI_ARCHIPELAGO_JUNK
    GET_ITEM(ITEM_NONE, OBJECT_ARCHIPELAGO_ITEM, GID_ARCHIPELAGO_JUNK, CUSTOM_MESSAGE_ID,
             GIFIELD(GIFIELD_20 | GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_SHORT),
    // #endregion
};
