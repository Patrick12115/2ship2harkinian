...
static void InstallHandlers() {
    ...
    sClient->set_slot_connected_handler([](const nlohmann::json data) {
        ...
        if (IS_ARCHI && sClient) {
            ...
            strncpy(gSaveContext.save.shipSaveInfo.archipelago.slotName, slotName.c_str(), 31);
            gSaveContext.save.shipSaveInfo.archipelago.slotName[31] = '\0'; // Ensure null termination
        }
