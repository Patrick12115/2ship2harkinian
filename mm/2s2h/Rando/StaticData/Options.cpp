...
std::map<RandoOptionId, RandoStaticOption> Options = {
    ...
    RO(RO_ACCESS_TRIALS,               RO_ACCESS_TRIALS_20_MASKS,        "access_trials"),
    ...
    RO(RO_CLOCK_TERMINAL_TIME,         0,                                "clock_terminal_time"), // Default: 00:00 (midnight)
    ...
    RO(RO_SKULLTULA_TOKENS_MAX,        SPIDER_HOUSE_TOKENS_REQUIRED,     "skulltula_tokens_max"),
