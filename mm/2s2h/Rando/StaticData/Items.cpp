...
std::map<RandoItemId, RandoStaticItem> Items = {
    ...
    RI(RI_ARCHIPELAGO_PROGRESSIVE,    "a",    "Progressive Item",           RITYPE_MAJOR,           ITEM_NONE,                       GI_ARCHIPELAGO_PROGRESSIVE,  GID_ARCHIPELAGO_PROGRESSIVE),
    RI(RI_ARCHIPELAGO_USEFUL,         "a",    "Useful Item",                RITYPE_LESSER,          ITEM_NONE,                       GI_ARCHIPELAGO_USEFUL,       GID_ARCHIPELAGO_USEFUL),
    RI(RI_ARCHIPELAGO_JUNK,           "",     "Junk Item",                  RITYPE_JUNK,            ITEM_NONE,                       GI_ARCHIPELAGO_JUNK,         GID_ARCHIPELAGO_JUNK),
};
