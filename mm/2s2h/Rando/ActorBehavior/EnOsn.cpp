...
void Rando::ActorBehavior::InitEnOsnBehavior() {
    COND_VB_SHOULD(VB_OSN_CONSIDER_ELIGIBLE_FOR_SONG_OF_HEALING, (IS_RANDO || IS_ARCHI), { *should = false; });

    COND_VB_SHOULD(VB_GIVE_ITEM_FROM_OSN, (IS_RANDO || IS_ARCHI), { *should = false; });
