...
void Rando::ActorBehavior::InitItemGetBehavior() {
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_BEAN, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
    ...
    // Deku Butler
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_EN_DNO, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_DANPEILIFT, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
        Player* player = GET_PLAYER(gPlayState);
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_BG_CRACE_MOVEBG, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
        Player* player = GET_PLAYER(gPlayState);
        if (PLAYER_IN_GET_ITEM_STATE(player)) {
            *should = false;
        }
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_LUPYGAMELIFT, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
        Player* player = GET_PLAYER(gPlayState);
        if (PLAYER_IN_GET_ITEM_STATE(player)) {
            *should = false;
        }
    ...
    COND_ID_HOOK(ShouldActorUpdate, ACTOR_OBJ_RAILLIFT, (IS_RANDO || IS_ARCHI), [](Actor* actor, bool* should) {
        Player* player = GET_PLAYER(gPlayState);
        if (PLAYER_IN_GET_ITEM_STATE(player)) {
            *should = false;
        }
